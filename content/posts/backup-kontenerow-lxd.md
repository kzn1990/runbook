...
draft = false
tags = ["lxd", "backup", "lxc"]
featureImage = "/content/images/2020/09/backup-lxd.jpg"
+++
...
[Projekt LXD](https://linuxcontainers.org/lxd/introduction/),\
[Backup lxd by redhat](https://lxd.readthedocs.io/en/latest/backup/).
