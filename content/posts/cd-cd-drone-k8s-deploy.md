...
Drone jest fajnym i lekkim toolem do Continuous Integration i Continuous Delivery/Deployment. Jak przy jego po mocy zdeployować coś do clustra k8s? Z pomocą przychodzi projekt dostępny na [GitHub'ie](https://github.com/sinlead/drone-kubectl).
...
{{< figure src="/content/images/2022/02/Drone_secrets.png" >}}
...
{{< figure src="/content/images/2022/02/obraz_2022-02-06_143135.png" >}}

Działamy tutaj na uprawnieniach _cluster-admin_ i oczywiście w celach labowych nie ma w tym nic złego. Do nadawani odpowiednich uprawnień w clustrze polecam zapoznać się z rozwiązaniem _**permission-manager**._

### Linki

[Drone](https://www.drone.io),[Permission-manager](https://github.com/sighupio/permission-manager).
